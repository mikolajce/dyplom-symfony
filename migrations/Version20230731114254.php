 ...
 */
final class Version20230731114254 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, client_id_id INT NOT NULL, status_id_id INT NOT NULL, sum_total DOUBLE PRECISION NOT NULL, INDEX IDX_F5299398DC2902E0 (client_id_id), INDEX IDX_F5299398881ECFA7 (status_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
